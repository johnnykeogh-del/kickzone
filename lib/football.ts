...
export const FOOTBALL_NEWS = [
  { id: 1, title: "Haaland Scores Hat-Trick to Send Man City Top! 🔥", summary: "Erling Haaland was unstoppable again, bagging three goals as Manchester City thrashed their rivals 4-0 at the Etihad Stadium.", image: "⚽", tag: "Premier League", time: "2 hours ago", hot: true },
  { id: 2, title: "Mbappé Makes Stunning Real Madrid Debut in El Clásico!", summary: "Kylian Mbappé showed the world exactly why Real Madrid paid a fortune for him, scoring twice in a 3-2 victory over Barcelona.", image: "⚽", tag: "La Liga", time: "5 hours ago", hot: true },
  { id: 3, title: "Lamine Yamal: The 17-Year-Old Changing Football Forever", summary: "Barcelona's teenage sensation is breaking records left and right — and he's only just getting started!", image: "⭐", tag: "Rising Star", time: "8 hours ago", hot: false },
  { id: 4, title: "Champions League Draw: The Ties Every Fan is Talking About", summary: "The Champions League knockout draw produced some mouth-watering fixtures that have fans around the world excited.", image: "🏆", tag: "Champions League", time: "1 day ago", hot: false },
  { id: 5, title: "Bellingham Named Best Young Player in Europe! 🏅", summary: "Jude Bellingham has taken Europe by storm with Real Madrid, and the awards are starting to pour in for the England star.", image: "🏅", tag: "Awards", time: "1 day ago", hot: false },
  { id: 6, title: "Premier League Title Race Goes to the Final Day!", summary: "Arsenal and Liverpool are neck and neck at the top — the title could be decided by goal difference on the last weekend of the season!", image: "🔥", tag: "Premier League", time: "2 days ago", hot: false },
]
